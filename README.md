...
<p align="center">
  <img src="docs/img/cs-framing-01.png" width="500" alt="SPI transaction capture showing CFGA and CFGB batched into a single continuous frame">
  <br><em>Two configuration commands sharing one CS assertion. The device sees one malformed command, not two good ones.</em>
</p>

<p align="center">
  <img src="docs/img/cs-framing-02.png" width="500" alt="Capture of the chip select line across a batched command pair">
  <br><em>CS never rises at the command boundary.</em>
</p>

<p align="center">
  <img src="docs/img/cs-framing-03.png" width="500" alt="Register readback showing stale values after a batched configuration write">
  <br><em>The result downstream: readback that does not match what was written.</em>
</p>
...
Splitting each command into its own CS-framed DMA transfer fixed it completely and permanently.

<p align="center">
  <img src="docs/img/dma-corrected-01.png" width="500" alt="SPI capture showing each command in its own CS frame">
  <br><em>Each command in its own frame, with the required gap.</em>
</p>

<p align="center">
  <img src="docs/img/dma-corrected-02.png" width="700" alt="Configuration register readback matching the written values">
  <br><em>Readback matches on every cycle.</em>
</p>
...
<p align="center">
  <img src="docs/img/systemview-interrupt-02.png" width="700" alt="Event log output from the interrupt-driven run">
  <br><em>Event log for the same run.</em>
</p>
